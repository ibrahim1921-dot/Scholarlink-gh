...
export const JobCreate: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    onFinish({
      ...
      requirements,
      // Format deadline to ISO string if needed by backend, assuming datetime-local produces YYYY-MM-DDTHH:mm
      ...
      <form onSubmit={handleSubmit}>
        <CardHeader className="flex flex-row items-center justify-between pb-6 border-b">
          <div className="flex items-center space-x-4">
            ...
            <CardTitle className="text-2xl text-primary font-bold">Create Job Listing</CardTitle>
          </div>
        </CardHeader>
        ...
        <CardFooter className="flex justify-end gap-4 border-t pt-6 pb-6">
          ...
          <Button type="submit" disabled={mutationResult.isLoading}>
            {mutationResult.isLoading ? "Creating..." : "Create Job"}
          </Button>
        </CardFooter>
      </form>
    </Card>
